...
|---|---|---|
| `result` | A record with the case/notice page and breach detail (court, Act section, regulation paragraph) | $0.003/record |
| `result-summary` | A lighter record: `fetchDetail: false` or `fetchBreachDetail: false`, or a page that could not be fetched | $0.001/record |
