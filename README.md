...
| `mainActivityContains`               | string   | -                            | A number (2-5 digits) matches the SIC code, prefix included (`43910` roofing, `43` all specialised construction); other text matches the activity description (`ROOFING`). Two different site columns - a code never matches as text                                                                                                                             |
